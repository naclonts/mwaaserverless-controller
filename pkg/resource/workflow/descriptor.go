...
const (
	FinalizerString = "finalizers.mwaaserverless.services.k8s.aws/Workflow"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("workflows")
	GroupKind            = metav1.GroupKind{
		Group: "mwaaserverless.services.k8s.aws",
		Kind:  "Workflow",
	}
)
